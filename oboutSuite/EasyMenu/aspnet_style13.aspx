...
<body>
	<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - Style13 skin</b></span>
		    <br /><br />	
			<br /><br />
	       ...
	       <span class="tdText">Right click this to see the Easy Menu:</span>
	        ...
	        <!--// The menus //-->
	        <oem:easymenu id="EasyMenu1" runat="server" StyleFolder="styles/style13" Width="145" UseIcons="false"
	        ...
	        <oem:easymenu id="EasyMenu2" runat="server" StyleFolder="styles/style13" Width="145" UseIcons="false" AttachTo="menuItem4" ShowEvent="MouseOver" Align="Right" OffsetHorizontal="-2" OffsetVertical="-2">
		        <Components>
