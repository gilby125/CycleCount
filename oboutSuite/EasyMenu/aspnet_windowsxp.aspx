    ...
    <body>
	     <form id="Form1" runat="server">
            ...
            <br /><br />
	            ...
	            <!--// The menus //-->
            <oem:easymenu id="EasyMenu1" runat="server" StyleFolder="styles/windowsxp" IconsFolder="icons" Width="140" UseIcons="true" AttachTo="div1" ShowEvent="ContextMenu" Align="Under">
	            <Components>
