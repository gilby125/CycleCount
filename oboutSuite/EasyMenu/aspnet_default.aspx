...
<body>
	<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - Default skin</b></span>
		    <br /><br />	
			<br /><br />  
	        ...
	        <!--// The menus //-->
	        <oem:easymenu id="EasyMenu1" runat="server" StyleFolder="styles" Width="140" UseIcons="false"	AttachTo="div1" ShowEvent="ContextMenu" Align="Under">
		        <Components>
			        ...
			        <oem:MenuItem ID="menuItem3">
				        <div style='valign: middle;'>Any <span style='background-color:gold; padding-left:2px; padding-right:2px;'>HTML</span></div>
			        </oem:MenuItem>
			        <oem:MenuSeparator InnerHtml="&lt;hr noshade size=1 &gt;" ID="menuSeparator1"></oem:MenuSeparator>
			        <oem:MenuItem InnerHtml="Browser Operations" ID="menuItem4"></oem:MenuItem>
			        <oem:MenuSeparator InnerHtml="&lt;hr noshade size=1 &gt;" ID="menuSeparator2"></oem:MenuSeparator>
			        <oem:MenuItem InnerHtml="Recycle" ID="menuItem5"></oem:MenuItem>
		        </Components>
	        </oem:easymenu>
	        <oem:easymenu id="EasyMenu2" runat="server" StyleFolder="styles" Width="140" UseIcons="false"	AttachTo="menuItem4" ShowEvent="MouseOver" Align="Right" OffsetHorizontal="-2" OffsetVertical="-2">
		        <Components>
