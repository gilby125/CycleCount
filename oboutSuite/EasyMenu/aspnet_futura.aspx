...
<body>
	<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - Futura skin</b></span>
		    <br /><br />	
			<br /><br /> 
	    ...
	    <!--// The menus //-->
	    <oem:easymenu id="EasyMenu1" runat="server" StyleFolder="styles/futura" Width="138" UseIcons="false" AttachTo="div1" ShowEvent="ContextMenu" Align="Under">
		    <Components>
			    ...
			    <oem:MenuItem InnerHtml="Recycle" ID="menuItem6"></oem:MenuItem>
		    </Components>
	    </oem:easymenu>
	    <oem:easymenu id="EasyMenu2" runat="server" StyleFolder="styles/futura" Width="138" UseIcons="false"	AttachTo="menuItem4" ShowEvent="MouseOver" Align="Right" OffsetHorizontal="-2" OffsetVertical="-2">
		    <Components>
