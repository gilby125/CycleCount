...
<body>
    <form id="Form1" runat="server">
        <span class="tdText"><b>ASP.NET Easy Menu -  VSNET skin</b></span>
	    <br /><br />	
		<br /><br /> 
	...
	<!--// The menus //-->
        <oem:easymenu id="EasyMenu1" runat="server" StyleFolder="styles/vsnet" IconsFolder="icons" Width="160" UseIcons="true" AttachTo="div1" ShowEvent="ContextMenu" Align="Under">
	        <Components>
		        ...
		        <oem:MenuSeparator ID="menuSeparator1" InnerHtml="&amp;nbsp;" AllowsIcon=true></oem:MenuSeparator>
		        <oem:MenuItem ID="menuItem4">Browser Operations</oem:MenuItem>
		        <oem:MenuSeparator ID="menuSeparator2" InnerHtml="&amp;nbsp;" AllowsIcon=true></oem:MenuSeparator>
		        <oem:MenuItem ID="menuItem6" Icon="xpRecycle.gif">Recycle</oem:MenuItem>
	        </Components>
        </oem:easymenu>
        <oem:easymenu id="EasyMenu2" runat="server" StyleFolder="styles/vsnet" IconsFolder="icons" Width="160" UseIcons="true" AttachTo="menuItem4" ShowEvent="MouseOver" Align="Right" OffsetHorizontal="-2" OffsetVertical="-2">
	        <Components>
