...
<html>
	...
	<body>
		<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - TabStrip1 skin</b></span>
		    <br /><br />	
			<br /><br /> 
					    ...
					    <table cellpadding="0" cellspacing="0">
						    ...
						    <tr>
							    <td style="padding-left:3px;">
								    <iframe style="border:3px solid #c0cff0;" frameborder="0" width="519px" height="150px" src="htmlPages/pageitem1.html" name="tabIframe" id="tabIframe"></iframe>
							    </td>
						    </tr>
					    </table>
				    </td>
