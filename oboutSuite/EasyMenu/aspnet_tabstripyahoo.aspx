...
<html>
	...
	<body>
		 <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - TabStrip Yahoo skin</b></span>
		    <br /><br />	
			<br /><br /></b>
			    ...
			    <tr>
				    <td>
					    <table cellpadding="0" cellspacing="0">
						    <tr>
							    <td>
								    <oem:EasyMenu SelectedItemId="item1" id="EasymenuTabStrip" runat="server" ShowEvent="Always" StyleFolder="styles/TabStripYahoo"
						    ...
						    <tr>
							    <td style="padding-left:1px;">
								    <iframe style="border:1px solid #9EA7B8;" name="tabIframe"  frameborder="0" width="526px" height="150px" src="htmlPages/pageitem1.html" id="tabIframe"></iframe>
							    </td>
						    </tr>
					    </table>
				    </td>
