...
<script runat="server">
    ...
    protected void setSpeed_Click(object sender, EventArgs e)
    {
        try
        {
            Easymenu3.DropdownIncrement = int.Parse(txtSlidingIncrement.Text);
            Easymenu3.DropInterval = int.Parse(txtSlidingSpeed.Text);
        }
...
<body>
	<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - Custom Sliding Effect</b></span>
		    <br /><br />	
			<br /><br />
	        ...
	        <!--// The menus //-->
	        <oem:EasyMenu id="Easymenu1" runat="server" ShowEvent="MouseOver" AttachTo="item1" Align="Under" OffsetHorizontal="-5" OffsetVertical="-2" Width="140" StyleFolder="styles/Horizontal1" >
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu4" runat="server" ShowEvent="MouseOver" AttachTo="item4" Align="Under" OffsetVertical="-2" Width="140" StyleFolder="styles/Vertical_Multiple">
		        <Components>
			        ...
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 4')" InnerHtml="Item44" ID="menuItem44"></oem:MenuItem>
						        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 1')" InnerHtml="Item45" ID="menuItem1"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 2')" InnerHtml="Item46" ID="menuItem2"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 3')" InnerHtml="Item47" ID="menuItem3"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 4')" InnerHtml="Item48" ID="menuItem4"></oem:MenuItem>
						        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 1')" InnerHtml="Item41" ID="menuItem5"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 2')" InnerHtml="Item49" ID="menuItem6"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 3')" InnerHtml="Item50" ID="menuItem7"></oem:MenuItem>
			        <oem:MenuItem OnClientClick="alert('Item 4 - SubItem 4')" InnerHtml="Item51" ID="menuItem8"></oem:MenuItem>
		        </Components>
	        </oem:EasyMenu>
	        <oem:EasyMenu id="Easymenu13" runat="server" ShowEvent="MouseOver" AttachTo="menuItem13" Align="Right" Width="140" StyleFolder="styles/Horizontal1">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu21" runat="server" ShowEvent="MouseOver" AttachTo="menuItem21" Align="Right" Width="140" StyleFolder="styles/Horizontal1">
		        <Components>
			        <oem:MenuItem OnClientClick="alert('Item 2 - SubItem 1 - SubItem 1')" InnerHtml="Item211" ID="menuItem211"></oem:MenuItem>
		        </Components>
	        </oem:EasyMenu>
	        <oem:EasyMenu id="Easymenu22" runat="server" ShowEvent="MouseOver" AttachTo="menuItem22" Align="Right" Width="140" StyleFolder="styles/Horizontal1">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu222" runat="server" ShowEvent="MouseOver" AttachTo="menuItem222" Align="Right" Width="140" StyleFolder="styles/Vertical_Multiple">
		        <Components>
	        ...
	        <br /><br /><br />Set sliding effect for Menu Item3 <br /><br />
        	
	          <table><tr><td>Dropdown Interval: </td><td><asp:TextBox ID="txtSlidingSpeed" runat="server" Text="10"></asp:TextBox></td></tr>
          <tr><td>Dropdown Increment: </td><td><asp:TextBox ID="txtSlidingIncrement" runat="server" Text="10"></asp:TextBox></td></tr></table>  
          <asp:Button ID="setSpeed" runat="server" Text="Set sliding effect" OnClick="setSpeed_Click" />
