...
<html>
	...
	<body>
		<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - TabStrip2 skin</b></span>
		    <br /><br />	
			<br /><br /> 
			    ...
			    <tr>
				    <td>
					    <table cellpadding="0" cellspacing="0">
						    <tr>
							    <td>
								    <oem:EasyMenu SelectedItemId="item1" id="EasymenuTabStrip" runat="server" ShowEvent="Always" StyleFolder="styles/TabStrip2"
						    ...
						    <tr>
							    <td style="padding-left:1px;">
								    <iframe style="border:3px solid #9DAEC2;" name="tabIframe"  frameborder="0" width="522px" height="150px" src="htmlPages/pageitem1.html" id="tabIframe"></iframe>
							    </td>
						    </tr>
					    </table>
