...
<html>
	...
	function disableTab( idx ){
		var tabTag = document.getElementById( "item" + idx );
		if ( tabTag == null )
		{
			return;
		}
		tabTag.firstChild.firstChild.firstChild.firstChild.nextSibling.style.cssText = "cursor:default ;text-decoration: line-through;";
		disTabArr.push("" + idx);
	}

	function enableTab( idx ){
		var tabTag = document.getElementById( "item" + idx );
		if ( tabTag == null )
		{
			return;
		}
		tabTag.firstChild.firstChild.firstChild.firstChild.nextSibling.style.cssText = "cursor:default;";
		for ( var i = 0; i< disTabArr.length ; i++)
		{
			//check this select tab is in disable tabs
			if ( disTabArr[i] == "" + idx )
			{
				//remove it from disable tabs
				disTabArr.splice( i, 1 );
			}
		}
	}
	...
	function SelectTab(idx)
	{
		...
		if ( is_ie )
		{
			lastTag.className= "mytab2";
			selectedTag.className= "mytab";
	...
	function validateOrder(){
		...
		if ( qty.value < 1 )
		{
			...
			alert("Quantity value must greater 0.");
			qty.focus();
			return false;
		}
	...
	function validateShipping(){
		var shipAdd = document.myForm.shipAdd;
		if (shipAdd.value == "")
		{
		...
		var shipDate = document.myForm.shipDate;
		if ( shipDate.value == "")
		{
			
			alert("Please enter shipping before day.");
			shipDate.focus();
			return false;
		}
										...
										<table width="100%">
											<tr>
												...
												<td valign="middle" align="left" class="tdtext">
													<input type="text" id="name" value="" maxlength="40" class="tdtext"><span style="color: red;">*</span>
												</td>
											</tr>
											<tr>
												<td valign="middle" align="left" width="150" class="tdtext">
												...
												<td valign="middle" align="left" class="tdtext">
													<input type="text" id="address" value="" class="tdtext"><span style="color: red;">*</span>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td valign="middle" align="left" colspan="2" class="tdtext">
									...
									<td valign="middle" align="center">
										<table width="100%">
											...
											<tr>
												...
												<td valign="middle" align="left" class="tdtext">
													<input type="text" id="qty" value="" class="tdtext"><span style="color: red;">*</span>
												</td>
											</tr>
											<tr>
												<td valign="middle" align="center" colspan="2"><br />
								...
								<td valign="middle" align="center">
									<table width="100%">
										<tr>
											...
											<td valign="middle" align="left" class="tdtext">
												<input type="text" id="shipAdd" value="" maxlength="40" class="tdtext"><span style="color: red;">*</span>
											</td>
										</tr>
										<tr>
											<td valign="middle" align="left" width="150" class="tdtext">
											...
											<td valign="middle" align="left" class="tdtext">
												<input type="text" name="shipDate" id="shipDate" value="" class="tdtext"><span style="color: red;">*</span>
											</td>
										</tr>
										<tr>
											<td valign="middle" align="center" colspan="2"><br />
