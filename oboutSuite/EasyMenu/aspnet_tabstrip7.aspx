...
<body>
    <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - TabStrip7 skin</b></span>
		    <br /><br />	
			<br /><br /> 
			    ...
			    <tr>
				    <td>
					    <table cellpadding="0" cellspacing="0">
						    <tr>
							    <td>
								    <oem:EasyMenu SelectedItemId="item1" id="EasymenuTabStrip" runat="server" ShowEvent="Always" StyleFolder="styles/TabStrip7"
						    ...
						    <tr>
							    <td style="padding-left:2px;">
								    <iframe style="border:1px solid #AC9482;border-top:0px;" name="tabIframe"  frameborder="0" width="524px" height="150px" src="htmlPages/pageitem1.html" id="tabIframe"></iframe>
							    </td>
						    </tr>
					    </table>
				    </td>
