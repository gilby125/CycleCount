...
<body>
	<form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Easy Menu - Horizontal 8 skin</b></span>
		    <br /><br />	
			<br /><br />
	        ...
	        <!--// The menus //-->
	        <oem:EasyMenu id="Easymenu1" runat="server" ShowEvent="MouseOver" AttachTo="item1" Align="Under" OffsetVertical="-4" OffsetHorizontal="-1" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu2" runat="server" ShowEvent="MouseOver" AttachTo="item2" Align="Under" OffsetVertical="-4" OffsetHorizontal="-1" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
			        <oem:MenuItem InnerHtml="Item21" ID="menuItem21"></oem:MenuItem>
			        <oem:MenuItem InnerHtml="Item22" ID="menuItem22"></oem:MenuItem>
		        </Components>
	        </oem:EasyMenu>
	        <oem:EasyMenu id="Easymenu3" runat="server" ShowEvent="MouseOver" AttachTo="item3" Align="Under" OffsetVertical="-4" OffsetHorizontal="-1" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu4" runat="server" ShowEvent="MouseOver" AttachTo="item4" Align="Under" OffsetVertical="-4" OffsetHorizontal="-1" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu13" runat="server" ShowEvent="MouseOver" AttachTo="menuItem13" Align="Right" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu21" runat="server" ShowEvent="MouseOver" AttachTo="menuItem21" Align="Right" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
			        <oem:MenuItem OnClientClick="alert('Item 2 - SubItem 1 - SubItem 1')" InnerHtml="Item211" ID="menuItem211"></oem:MenuItem>
		        </Components>
	        </oem:EasyMenu>
	        <oem:EasyMenu id="Easymenu22" runat="server" ShowEvent="MouseOver" AttachTo="menuItem22" Align="Right" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
	        ...
	        <oem:EasyMenu id="Easymenu222" runat="server" ShowEvent="MouseOver" AttachTo="menuItem222" Align="Right" Width="140" StyleFolder="styles/horizontal8">
		        <Components>
