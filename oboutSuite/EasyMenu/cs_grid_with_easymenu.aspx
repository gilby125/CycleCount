<%@ Page Language="C#" Src="cs_grid_with_easymenu.aspx.cs" Inherits="GridWithEm" %>
...
<script>
	...
	function attachMenuToRecords() {
		...
		var gridContainerID = '<%=((Obout.Grid.Grid)ph1.FindControl("grid1")).ClientID%>_ob_grid1MainContainer';
