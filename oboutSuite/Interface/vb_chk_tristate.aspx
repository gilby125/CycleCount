...
<script type="text/VB" runat="server">
    Dim ChkTechnologies As OboutCheckBox
    Dim ChkNetFramework As OboutCheckBox
    Dim ChkAspNet As OboutCheckBox
    Dim OboutCheckBox1 As OboutCheckBox
    Dim OboutCheckBox2 As OboutCheckBox
    Dim OboutCheckBox3 As OboutCheckBox
    Dim ChkCSharp As OboutCheckBox
    Dim ChkVB As OboutCheckBox
    Dim ChkOther As OboutCheckBox
    Dim ChkPhp As OboutCheckBox
    Dim ChkRuby As OboutCheckBox
    Dim ChkJava As OboutCheckBox
