<%@ Page UICulture="auto" Language="VB" AutoEventWireup="true" CodeFile="vb_CustomColors.aspx.vb" Inherits="ColorPicker_vb_CustomColors" %>
<%@ Register
...
<body>
    <span class="tdText"><b>Obout.Ajax.UI.ColorPicker</b> - Custom colors</span>
    <br /><br />
    ...
    <center>
        ...
        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
          <ContentTemplate>
             ...
             <obout:ColorPickerExtender runat="server" ID="spelcheck" OnClientOpen="onClientOpen"
