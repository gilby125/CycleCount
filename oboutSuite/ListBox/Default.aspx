	...
	void Page_load(object sender, EventArgs e)
	{
		try
		{
			...
			while (oXMLReader.Read())
			{
				...
				{
					lblPath.Text = "<b>Path to folder with ListBox examples: </b>" + oXMLReader.ReadString();
				}
			}
			oXMLReader.Close();
		}
...
<head runat="server">
    <title>obout ListBox examples</title>
    <style type="text/css">
		td.link{
			padding-left:30px;
			width:250px;			
...
<body>
    ...
    <span class="tdText">
        ...
        <br /><br /><br />
        <span style="font-weight:bold;">obout ASP.NET ListBox examples</span> (version 1.0.8, released on May 14, 2011)        
        <br /> 
        <br />
            ...
            <tr>
                <td>
                    <div id="divASPNET">
                            ...
                            <tr>
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="header" colspan="2"><b>Load on Demand</b> - <span class="headerNumber">3</span></td>
				                        </tr>
			                            <tr>
				                            <td class="link">
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_columns_grid_ondemand.aspx">Load Multi-Columns on Demand</a>
				                            </td>
                        	    ...
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_master_detail_cascading.aspx">Cascading ListBoxes</a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_integration_radiobtn.aspx">RadioButtons inside ListBox</a>
				                            </td>
					                        <td>aspnet_integration_radiobtn.aspx</td>
			                            </tr>
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_integration_grid.aspx">ListBox inside Grid</a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="header" colspan="2"><b>Settings</b> - <span class="headerNumber">3</span></td>
				                        </tr>
				                        <tr>
				                            <td class="link" nowrap="nowrap">
			                            ...
			                            <tr>
				                            <td class="header" colspan="2"><b>Server-Side API</b> - <span class="headerNumber">4</span></td>
				                        </tr>
				                        <tr>
				                            <td class="link" nowrap="nowrap">
			                            ...
			                            <tr>
				                            <td class="header" colspan="2"><b>Client-Side API</b> - <span class="headerNumber">8</span></td>
				                        </tr>
				                        <tr>
				                            <td class="link" nowrap="nowrap">
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_apiclient_items_columns.aspx">Add Multi-Column Items <b style="color: crimson;">New</b></a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="aspnet_apiclient_move_updown.aspx">Move Items <b style="color: crimson;">New</b></a>
				                            </td>
					                        <td>aspnet_apiclient_move_updown.aspx</td>
			                            </tr>
			            ...
			            <br />
			            <span class="tdText">
				            You can find the ASP.NET examples in the <b>ListBox</b> folder.<br />
                            ...
                            <tr>
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_columns_grid_ondemand.aspx">Load Multi-Columns on Demand</a>
				                            </td>
                        	    ...
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_master_detail_cascading.aspx">Cascading ListBoxes</a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_integration_radiobtn.aspx">RadioButtons inside ListBox</a>
				                            </td>
					                        <td>cs_integration_radiobtn.aspx</td>
			                            </tr>
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_integration_grid.aspx">ListBox inside Grid</a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_apiclient_items_columns.aspx">Add Multi-Column Items <b style="color: crimson;">New</b></a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="cs_apiclient_move_updown.aspx">Move Items <b style="color: crimson;">New</b></a>
				                            </td>
					                        <td>cs_apiclient_move_updown.aspx</td>
			                            </tr>
                            ...
                            <tr>
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_columns_grid_ondemand.aspx">Load Multi-Columns on Demand</a>
				                            </td>
                        	    ...
                        	    <td valign="top">
                        	        <table>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_master_detail_cascading.aspx">Cascading ListBoxes</a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_integration_radiobtn.aspx">RadioButtons inside ListBox</a>
				                            </td>
					                        <td>vb_integration_radiobtn.aspx</td>
			                            </tr>
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_integration_grid.aspx">ListBox inside Grid</a>
				                            </td>
			                            ...
			                            <tr>
					                        ...
					                        <td>vb_aspnet_apiserver_get_values.aspx</td>
			                            </tr>
			                             <tr>
				                            <td class="link" nowrap="nowrap">
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_apiclient_items_columns.aspx">Add Multi-Column Items <b style="color: crimson;">New</b></a>
				                            </td>
			                            ...
			                            <tr>
				                            <td class="link" nowrap="nowrap">
					                            <a href="vb_apiclient_move_updown.aspx">Move Items <b style="color: crimson;">New</b></a>
				                            </td>
					                        <td>vb_apiclient_move_updown.aspx</td>
			                            </tr>
        ...
        <br />
        <br />
        <a href="http://www.obout.com/listbox">obout ListBox home</a>
        <br />
