<%@ Page Title="" Language="C#" MasterPageFile="~/ListBox/ListBox.master" AutoEventWireup="true" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
   ...
   <span class="tdText"><b>ASP.NET ListBox - Client-Side API - Add Multi-Column Items</b></span>	
        ...
        <tr>
            <td>
                <obout:ListBox runat="server" ID="ListBox1" Width="400" Height="150"
                    ...
                    <ItemTemplate><div class="item c1"><%# Eval("SupplierID") %></div><div class="item c2"><%# Eval("CompanyName") %></div><div class="item c3"><%# Eval("City") %></div></ItemTemplate>
                    <FooterTemplate>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="head">
    <script type="text/javascript">
        function addItem() {
            ...
            ListBox1.options.add(OboutTextBox2.value(), OboutTextBox1.value(), 0);            
