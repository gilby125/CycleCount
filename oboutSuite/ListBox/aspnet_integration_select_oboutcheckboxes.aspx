<%@ Page Language="C#" MasterPageFile="~/ListBox/ListBox.master" AutoEventWireup="true" CodeFile="aspnet_integration_select_oboutcheckboxes.aspx.cs" Inherits="ListBox_aspnet_integration_select_oboutcheckboxes" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <table>
        <tr>
            <td valign="top">
                <obout:ListBox runat="server" ID="ListBox1" Width="200" SelectionMode="Single"
                    DataSourceID="sds1" DataTextField="ControlName" DataValueField="ControlID">
                    <ItemTemplate>
                        <div class="item">
                            <span>
                                <obout:OboutCheckBox runat="server" ID="OboutCheckBox1">
                                    <ClientSideEvents OnCheckedChanged="updateListBoxSelection" />
                                </obout:OboutCheckBox>
                            </span>
                            <div class="label">
                    ...
                    <ClientSideEvents OnItemClick="ListBox1_ItemClick" />
                </obout:ListBox>
            </td>
            <td valign="top">
