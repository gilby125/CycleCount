<%@ Page Title="" Language="C#" MasterPageFile="~/ListBox/ListBox.master" AutoEventWireup="true" CodeFile="aspnet_populate_dataset.aspx.cs" Inherits="ListBox_aspnet_selection_retrieve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:ListBox runat="server" ID="ListBox1" Height="200" Width="225"
