<%@ Page Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_ondemand_minchars.aspx.cs" Inherits="ComboBox_aspnet_ondemand_minchars" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <obout:ComboBox runat="server" ID="ComboBox1" Width="200" Height="200" AllowCustomText="true" AutoValidate="true"
