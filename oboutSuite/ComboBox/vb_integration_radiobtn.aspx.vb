...
Partial Class ComboBox_vb_integration_radiobtn
    ...
    Sub Page_load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        ComboBox1.Items.Add(New Obout.ComboBox.ComboBoxItem())

        ComboBox1Container.Controls.Add(ComboBox1)
    End Sub
    Sub Order(ByVal sender As Object, ByVal e As EventArgs)

        If Not (String.IsNullOrEmpty(ComboBox1.SelectedText)) Then
