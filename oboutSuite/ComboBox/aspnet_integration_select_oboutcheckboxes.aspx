<%@ Page Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_integration_select_oboutcheckboxes.aspx.cs" Inherits="ComboBox_aspnet_integration_select_oboutcheckboxes" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        function updateComboBoxSelection() {
            ...
            var elements = ComboBox1.ItemsContainer.getElementsByTagName('INPUT');
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <span class="tdText"><b>ASP.NET ComboBox - Select/Deselect All Obout CheckBoxes</b></span>	
    ...
    <table>
        <tr>
            <td valign="top">
                <obout:ComboBox runat="server" ID="ComboBox1" Width="200" AllowEdit="false" SelectionMode="Single"
                    DataSourceID="sds1" DataTextField="ControlName" DataValueField="ControlID">
                    <ItemTemplate>
                        <div class="item">
                            <span>
                                <obout:OboutCheckBox runat="server" ID="OboutCheckBox1">
                                    <ClientSideEvents OnCheckedChanged="updateComboBoxSelection" />
                                </obout:OboutCheckBox>
                            </span>
                            <div class="label">
