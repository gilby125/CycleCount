<%@ Page Title="" Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_apiserver_events.aspx.cs" Inherits="ComboBox_aspnet_selection_retrieve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText"><b>ASP.NET ComboBox - Server-Side API - Events</b></span>
    ...
    <span class="tdText">
        The ComboBox control provides server-side events that allow you to detect<br />
