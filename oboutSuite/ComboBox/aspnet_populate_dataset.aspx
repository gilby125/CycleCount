<%@ Page Title="" Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_populate_dataset.aspx.cs" Inherits="ComboBox_aspnet_selection_retrieve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:ComboBox runat="server" ID="ComboBox1" Height="200" Width="225"
