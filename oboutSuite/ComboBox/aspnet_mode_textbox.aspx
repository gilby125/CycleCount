<%@ Page Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_mode_textbox.aspx.cs" Inherits="ComboBox_aspnet_mode_textbox" %>
        ...
        <tr>
            <td>
                ...
                <obout:ComboBox runat="server" ID="ComboBox1" Width="250" Height="200"
                    Mode="TextBox" EmptyText="Select a customer ..."
            ...
            <td>
                ...
                <obout:ComboBox runat="server" ID="ComboBox2" Width="250" Height="200"
                    Mode="TextBox" SelectionMode="Multiple" EmptyText="Select a customer ..."
                    DataSourceID="sds1" DataTextField="CompanyName" DataValueField="CustomerID"
                    />
            </td>
            <td width="20">&#160;</td>
            <td>
                ...
                <obout:ComboBox runat="server" ID="ComboBox3" Width="250" Height="200"
                    Mode="TextBox" EmptyText="Select a country ..."
