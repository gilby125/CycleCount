<%@ Page Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_ondemand_virtual_scroll.aspx.cs" Inherits="ComboBox_aspnet_ondemand" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <span class="tdText"><b>ASP.NET ComboBox - Virtual Scrolling</b></span>	
    ...
    <obout:ComboBox runat="server" ID="ComboBox1" Width="250" Height="200"
        ...
        EnableVirtualScrolling="true" EmptyText="Select a country ...">
        <FooterTemplate>
