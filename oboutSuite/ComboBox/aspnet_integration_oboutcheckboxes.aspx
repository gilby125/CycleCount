<%@ Page Language="C#" MasterPageFile="~/ComboBox/ComboBox.master" AutoEventWireup="true" CodeFile="aspnet_integration_oboutcheckboxes.aspx.cs" Inherits="ComboBox_aspnet_integration_checkboxes" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        ...
        function attachCheckBoxesOnClickHandlers() {
            ...
            var elements = ComboBox1.ItemsContainer.getElementsByTagName('SPAN');
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <span class="tdText"><b>ASP.NET ComboBox - Items with OboutCheckBox controls</b></span>	
    
    <br /><br />
    
    
    <obout:ComboBox runat="server" ID="ComboBox1" Width="350"
        AutoClose="false" AllowCustomText="true" AutoValidate="true" AllowEdit="false" SelectionMode="Multiple"
