...
<html>
	...
	<body>	
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false" ShowLoadingMessage="false"
			 FolderStyle="styles/premiere_blue"  EnableRecordHover="true" AllowFiltering="true"
