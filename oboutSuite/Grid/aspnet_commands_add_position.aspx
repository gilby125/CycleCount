<%@ Page Title="" Language="C#" MasterPageFile="~/Grid/Grid.master" AutoEventWireup="true" CodeFile="aspnet_commands_add_position.aspx.cs" Inherits="Grid_aspnet_commands_add_position" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:Grid id="Grid1" runat="server" DataSourceID="SqlDataSource1" FolderStyle="styles/black_glass"        
        AutoGenerateColumns="false" AllowAddingRecords="true" Serialize="false" >
        <Columns>
            <obout:Column DataField="OrderID" Visible="false" />
            <obout:Column DataField="ShipCountry" HeaderText="SHIP COUNTRY" Width="150" />            
            <obout:Column DataField="ShipCity" HeaderText="SHIP CITY" Width="150" />
            <obout:Column DataField="ShipPostalCode" HeaderText="POSTAL CODE" Width="150" />
            <obout:Column DataField="ShipName" HeaderText="SHIP NAME" Width="150" />
            <obout:Column AllowEdit="true" AllowDelete="true" Width="150" />
        </Columns>
