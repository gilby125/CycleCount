...
<script language="VB" runat="server">
	...
	Sub Page_load(ByVal sender As Object, ByVal e As EventArgs )
        ...
        If Not Page.IsPostBack Then
            ...
            oRecord.Add("OrderID", "11073")
            oRecord.Add("ShipName", "Pericles Comidas clsicas")
            oRecord.Add("ShipCity", "Mxico D.F.")
            oRecord.Add("ShipPostalCode", "05033")
            oRecord.Add("ShipCountry", "Mexico")

            Dim oRecord2 As Hashtable = New Hashtable()
            oRecord2.Add("OrderID", "11070")
            oRecord2.Add("ShipName", "Lehmanns Marktstand")
            oRecord2.Add("ShipCity", "Frankfurt a.M. ")
            oRecord2.Add("ShipPostalCode", "60528")
            oRecord2.Add("ShipCountry", "Germany")
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Set the Selected Records on the Server-Side</b></span>
		<br /><br />	
		...
		<span class="tdText">
		    Use the <b>SelectedRecords</b> collection to set the selected records on server-side.		   
		</span>
