...
<html>
	...
	<body>	
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			 FolderStyle="styles/premiere_blue" EnableRecordHover="true" AllowAddingRecords="false">
			<Columns>				
				<obout:Column DataField="ShipName" HeaderText="NAME" Width="400" runat="server"/>				
