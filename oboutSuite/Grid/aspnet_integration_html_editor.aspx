...
<body>
    ...
    <obout:Grid ID="grid1" runat="server" Serialize="true" AutoGenerateColumns="false"
        FolderStyle="styles/grand_gray" OnRebind="RebindGrid" OnInsertCommand="InsertRecord" OnDeleteCommand="DeleteRecord" OnUpdateCommand="UpdateRecord">
        ...
        <Templates>
            <obout:GridTemplate runat="server" ControlID="EditorContent" ID="tmpEditor" ControlPropertyName="value">
                <Template>
                    <obout:Editor runat="server" ID="Editor" Height="250" Width="550" PopupHolderID="popupHolder">
