...
<script language="VB" runat="server">
	...
	Sub Page_load(ByVal sender As Object, ByVal e As EventArgs )
		...
		' The Grid is binded to the datasource each time the page loads
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>Large ASP.NET Grid</b></span>
		<br /><br />
		...
		<span class="tdText">
		For large grids (around 1000 records and above) we suggest you to set the <b>Serialize</b> property<br />
		to <span class="option2">false</span>. The data will be retrived from the database after each AJAX request/postback<br />
		but this will be faster than saving huge amounts of data into the Viewstate.		
		</span>
