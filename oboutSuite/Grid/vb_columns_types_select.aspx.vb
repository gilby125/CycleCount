...
Partial Class Grid_vb_columns_types_select
    ...
    Sub Page_load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        DirectCast(grid1.Columns(1), CheckBoxSelectColumn).ControlType = IIf(RbtnStandard.Checked, GridControlType.Standard, GridControlType.Obout)
