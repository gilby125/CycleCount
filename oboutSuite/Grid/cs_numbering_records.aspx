...
<script language="C#" runat="server">
	...
	void Page_load(object sender, EventArgs e)		
	{
        ...
        //------------------------------------------------------------------------
        GridRuntimeTemplate NumberingRecordsTemplate = new GridRuntimeTemplate();
        NumberingRecordsTemplate.ID = "tplNumbering";
        NumberingRecordsTemplate.Template = new Obout.Grid.RuntimeTemplate();
        NumberingRecordsTemplate.Template.CreateTemplate += new Obout.Grid.GridRuntimeTemplateEventHandler(CreateNumberingRecordsTemplate);
        //------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------
    public void CreateNumberingRecordsTemplate(Object sender, Obout.Grid.GridRuntimeTemplateEventArgs e)
    {
        Literal oLiteral = new Literal();
        e.Container.Controls.Add(oLiteral);
        oLiteral.DataBinding += new EventHandler(DataBindNumberingRecordsTemplate);
    }
    protected void DataBindNumberingRecordsTemplate(Object sender, EventArgs e)
    {
