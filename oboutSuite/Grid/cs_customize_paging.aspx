...
<script language="C#" runat="server">
	...
	void Page_load(object sender, EventArgs e)		
	{
        ...
        grid1.AllowPaging = chkAllowPaging.Checked;
        grid1.AllowPageSizeSelection = chkAllowPageSizeSelection.Checked;	
	}	
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Customize the Page Size drop-down</b></span>
		
		<br /><br />
	
	    <fieldset class="tdText" style="width: 200px;">
		    <legend>Set Paging Properties</legend>
		    <asp:CheckBox runat="server" ID="chkAllowPaging" runat="server" Checked="true" AutoPostBack="true" /> AllowPaging <br />
		    <asp:CheckBox runat="server" ID="chkAllowPageSizeSelection" runat="server" Checked="true" AutoPostBack="true" /> AllowPageSizeSelection 
		</fieldset>
		...
		<span class="tdText">
		Use the <b>AllowPaging</b> property to enable/disable the paging feature.<br /><br />
		To show/hide the page size selection drop-down, use the <b>AllowPageSizeSelection</b> property.
		</span>
