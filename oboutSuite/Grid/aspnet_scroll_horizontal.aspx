...
<html>
	...
	<body>	
		<form runat="server">					
		<br />
		<span class="tdText"><b>ASP.NET Grid - Horizontal Scrolling</b></span>		
		<br /><br />
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false" AllowAddingRecords="false"
			...
			<ScrollingSettings ScrollWidth="700" />
		</obout:Grid>
					
		<br /><br /><br />
		
		<span class="tdText">
		    To enable the horizontal scrolling feature, use the <b>ScrollWidth</b> property.
		</span>
