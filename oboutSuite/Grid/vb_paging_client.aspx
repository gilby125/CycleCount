...
<script language="VB" runat="server">
	...
	Sub BindGrid()
        ...
        Dim myComm As OleDbCommand = New OleDbCommand("SELECT * FROM Orders ORDER BY OrderID DESC", myConn)
		myConn.Open()
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	<head>
		...
		function changeGridPage() {
		    var oTxtPage = document.getElementById("txtPage");
		    grid1.changePage(oTxtPage.value - 1);
		}
		</script>		
	</head>
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Changing the Page on the Client-Side</b></span>
		<br /><br />
		...
		<span class="tdText">
		Go to page: <input type="text" class="tdText" value="11" id="txtPage" /> <input type="button" class="tdText" value="GO" onclick="changeGridPage()" />
		</span>
					
		<br /><br /><br />
		
		<span class="tdText">
		Use the <b>changePage</b> client-side method to change the page of the Grid on the client-side.<br />
		This method has only an argument - the index of the page.
		</span>
