<%@ Page Title="" Language="C#" MasterPageFile="~/Grid/Grid.master" AutoEventWireup="true" CodeFile="aspnet_column_sets_levels.aspx.cs" Inherits="Grid_aspnet_column_sets_levels" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<span class="tdText"><b>ASP.NET Grid - Column Sets on Multiple Levels</b></span>		
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT TOP 50 C.CustomerID, C.CompanyName, C.ContactName, O.OrderID, O.ShipCity, O.ShipAddress, O.ShipCountry, O.OrderDate, O.ShippedDate 
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    ...
    <script type="text/javascript">
        window.onload = function () {
            ...
            Grid1.addColumnSet(0, 4, 8, 'ORDER INFORMATION');
            Grid1.addColumnSet(1, 2, 3, 'CUSTOMER');
            Grid1.addColumnSet(1, 4, 6, 'SHIP ADDRESS');
            Grid1.addColumnSet(1, 7, 8, 'SHIP DATES');
        }
    </script>
</asp:Content>