...
<html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Edit on Double Click</b></span>
		<br /><br />
				
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			FolderStyle="styles/grand_gray" AllowFiltering="false"
		...
		<span class="tdText">
		You can use the <b>OnClientDblClick</b> property to execute client-side functions when a record is double-clicked.<br />
		(This property is encapsulated in the <b>ClientSideEvents</b> section of the Grid)
        </span>
