...
<html>
	...
	<body>	
		<form runat="server">					
		<br />
		<span class="tdText"><b>ASP.NET Grid - Master / Detail - Loading the Detail Grids using the OnCallback pattern</b></span>		
		...
		<span class="tdText">
		    Set the <b>MasterDetailSettings.LoadingMode</b> property to <span class="option2">OnCallback</span> to load the detail grids using AJAX callbacks.<br />
		    Use this pattern for large master/detail hierarchies.
		</span>
