		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" 
			...
			<Templates>								
                ...
                <obout:GridTemplate runat="server" ID="addTemplate">
                    <Template>
                        <input type="button" class="tdTextSmall" value="Add New" onclick="grid1.addRecord()"/>
                    </Template>
                </obout:GridTemplate>
                <obout:GridTemplate runat="server" ID="saveTemplate">
                    <Template>
                        <input type="button" value="Save" class="tdTextSmall" onclick="grid1.insertRecord()"/> 
                        |
                        <input type="button" value="Cancel" class="tdTextSmall" onclick="grid1.cancelNewRecord()"/> 
                    </Template>
                </obout:GridTemplate>
                <obout:GridTemplate runat="server" ID="multirecord_save_cancel_tpl">
                    <Template>
                        <input type="button" value="Save All" class="tdTextSmall" onclick="grid1.saveAll()"/> 
                        |
                        <input type="button" value="Cancel All" class="tdTextSmall" onclick="grid1.cancelAll()"/> 
                    </Template>
                </obout:GridTemplate>                
