...
<html>
	...
	<body>	
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			...
			PageSizeOptions="1,5,10,15,20,25,30,35,40,45,50" PageSize="15">
			<Columns>
		...
		<span class="tdText">You can use the <b>PageSizeOptions</b> property of the Grid to set which options you<br />
		want to have for the "Records per page" drop-down</span>
