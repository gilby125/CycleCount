...
<html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Postback Mode</b></span>
		<br /><br />		
		
		<obout:Grid id="grid1" runat="server" CallbackMode="false" Serialize="true" AllowFiltering="true"
		...
		<span class="tdText">When the grid is in <b>postback mode</b>, all the actions (sorting, paging, editing etc.)<br />
		generate a postback of the page.</span>
