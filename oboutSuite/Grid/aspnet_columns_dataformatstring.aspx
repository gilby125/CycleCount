	...
	<body>	
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			...
			<Columns>				
				...
				<obout:Column DataField="ShippedDate" HeaderText="SHIPPED DATE" DataFormatString="{0:dd-MMM-yyyy}" Width="150" runat="server" />
				<obout:Column DataField="RequiredDate" HeaderText="REQUIRED DATE" DataFormatString="{0:MMMM dd, yyyy}" Width="150" runat="server" />
