...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Refresh the Records</b></span>
		<br /><br />
			
		<asp:PlaceHolder ID="phGrid1" runat="server"></asp:PlaceHolder>
					
		<br />
		<input type="button" class="tdText" value="Refresh" onclick="grid1.refresh()" />
		<br /><br /><br />
		<span class="tdText">
		    You can use the <b>refresh</b> client-side method to reload the records of the grid: 
		    <span class="option2">grid1.refresh();</span>
		</span>
