...
<script language="C#" runat="server">
    ...
    void ProcessSelectedOrders(object sender, EventArgs e)
    {
        ...
        {
            GridDataControlFieldCell cell = grid1.RowsInViewState[i].Cells[0] as GridDataControlFieldCell;
...
<html>
	...
	<body>	
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="false" Serialize="true" AllowAddingRecords="true"
			FolderStyle="styles/premiere_blue" AutoGenerateColumns="false" AllowRecordSelection="false" AllowMultiRecordSelection="false"
