...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	<head>
		...
		<script type="text/javascript">
		    function getGridValue() {
		        var oTxtRow = document.getElementById("txtRow");
		        var oTxtCell = document.getElementById("txtCell");
		        
		        try {
		            alert(grid1.Rows[oTxtRow.value - 1].Cells[oTxtCell.value - 1].Value);
		        } catch(ex) {}
		    }
		</script>		
	</head>
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Using the Client-Side Model to access the data inside the Grid</b></span>
		<br /><br />
		...
		<span class="tdText">
		    Row: <input type="text" id="txtRow" class="tdText" size="4" value="1" /> 
		    Cell: <input type="text" id="txtCell" class="tdText" size="4" value="3" /> 
		    <input type="button" class="tdText" value="Get Value" onclick="getGridValue()" />
		</span>
					
		<br /><br /><br />
		
		<span class="tdText">
		    The data inside the cells of the Grid can easily be accessed using the client-side model of the Grid:<br />
		    <span class="option2">
		        <br />
		        var city = grid1.Rows[0].Cells[2].Value;<br />
		        alert(city);
		    </span>
		</span>
