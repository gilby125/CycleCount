...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"> <html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Visible property for the Columns</b></span>
		<br /><br />
		...
		<span class="tdText">
		Sometimes you need to access some values from the database, but you don't want to display them in the Grid<br />
		(for example primary key columns, autogenerated columns etc.)
		<br /><br />
		Set the <b>Visible</b> property of the Column class to <span class="option2">false</span> and the column won't be appear in the Grid.
		<br /><br />
		In this example, the "OrderID" columns is not visible.
		</span>
