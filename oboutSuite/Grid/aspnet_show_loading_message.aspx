...
<script language="C#" runat="server">	
	...
	{
        grid1.ShowLoadingMessage = chkShowLoadingMessage.Checked;
...
<html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Showing the Loading Message</b></span>
		<br /><br />
		
		<table>
		    <tr>
		        <td class="tdText"><input type="checkbox" runat="server" id="chkShowLoadingMessage" /></td>
		        <td class="tdText">Show the Loading Message</td>
		    </tr>
		     <tr>		        
		        <td class="tdText" colspan="2"><input type="submit" value="Submit" class="tdText" /></td>
		    </tr>
		</table>
		...
		<span class="tdText">
		Set the <b>ShowLoadingMessage</b> property of the Grid class to <span class="option2">false</span> and the <br />
		"Loading..." message won't be displayed anymore when a callback is triggered.
		</span>
