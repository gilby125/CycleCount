...
<head>
    ...
    <script>
        function EmailFillDetails(EmailID) {
	        window.parent.sp2.loadPage("RightContent", "aspnet_integration_email_client_detail.aspx?EmailID=" + EmailID);
        }

        function fillDetailsFromGrid(arrSelectedRecords) {
            window.parent.sp2.loadPage("RightContent", "aspnet_integration_email_client_detail.aspx?EmailID=" + arrSelectedRecords[0].EmailID);    
        }
