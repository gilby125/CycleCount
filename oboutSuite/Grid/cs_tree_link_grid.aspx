...
<script language="C#" runat="server">
	...
	{		
		if (!Page.IsPostBack)
		{
            Node rootNode = new Node() { Expanded = true, Text = "Working time", ClientID = "root", ImageUrl = "../treeview/icons/xpMyComp.gif" };
            ObTree.Nodes.Add(rootNode);

            // Populate Treeview.
            Node a_0 = new Node() { Expanded = true, Text = "Albert Yap", ClientID = "a_0", ImageUrl = "../treeview/icons/folder.gif" };
            rootNode.ChildNodes.Add(a_0);
            a_0.ChildNodes.Add(new Node() { Text = "1st half of March", ClientID = "a_1", ImageUrl = "../treeview/icons/page.gif" });
            a_0.ChildNodes.Add(new Node() { Text = "2nd half of March", ClientID = "a_2", ImageUrl = "../treeview/icons/page.gif" });
            a_0.ChildNodes.Add(new Node() { Text = "1st half of April", ClientID = "a_3", ImageUrl = "../treeview/icons/page.gif" });
            a_0.ChildNodes.Add(new Node() { Text = "2st half of March", ClientID = "a_4", ImageUrl = "../treeview/icons/page.gif" });

            Node a_5 = new Node() { Expanded = true, Text = "Mike Baker", ClientID = "a_5", ImageUrl = "../treeview/icons/folder.gif" };
            rootNode.ChildNodes.Add(a_5);
            a_5.ChildNodes.Add(new Node() { Text = "1st half of March", ClientID = "a_6", ImageUrl = "../treeview/icons/page.gif" });
            a_5.ChildNodes.Add(new Node() { Text = "2nd half of March", ClientID = "a_7", ImageUrl = "../treeview/icons/page.gif", Selected = true });
            a_5.ChildNodes.Add(new Node() { Text = "1st half of April", ClientID = "a_8", ImageUrl = "../treeview/icons/page.gif" });
            a_5.ChildNodes.Add(new Node() { Text = "2st half of March", ClientID = "a_9", ImageUrl = "../treeview/icons/page.gif" });
	...
	void CreateGrid()
	{
        ...
        OleDbCommand myComm = new OleDbCommand("SELECT *, (Sun + Mon + Tue + Wed + Thu + Fri + Sat) AS Total,(Sun2 + Mon2 + Tue2 + Wed2 + Thu2 + Fri2 + Sat2) AS Total2 FROM March WHERE ID < 11 ORDER BY ID ASC", myConn);
		myConn.Open();		
