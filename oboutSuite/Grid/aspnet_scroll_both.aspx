...
<script language="C#" runat="server">	
    ...
    void InsertRecord(object sender, GridRecordEventArgs e)
    {
        ...
        OleDbCommand myComm = new OleDbCommand("INSERT INTO Orders (ShipName, ShipCity, ShipPostalCode, ShipCountry, OrderDate, ShipVia) VALUES(@ShipName, @ShipCity, @ShipPostalCode, @ShipCountry, @OrderDate, @ShipVia)", myConn);
...
<html>
	...
	<body>	
		<form runat="server">					
		<br />
		<span class="tdText"><b>ASP.NET Grid - Vertical & Horizontal Scrolling</b></span>		
		<br /><br />
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			FolderStyle="styles/black_glass" PageSize="50" AllowFiltering="false"
			...
			<ScrollingSettings ScrollHeight="250" ScrollWidth="700"/>
		</obout:Grid>
					
		<br /><br /><br />
		
		<span class="tdText">
		    For large grids, you can use both <b>ScrollWidth</b> and <b>ScrollHeight</b> properties.
		</span>
