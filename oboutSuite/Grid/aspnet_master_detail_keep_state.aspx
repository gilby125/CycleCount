<%@ Page Title="" Language="C#" MasterPageFile="~/Grid/Grid.master" AutoEventWireup="true" CodeFile="aspnet_master_detail_keep_state.aspx.cs" Inherits="Grid_aspnet_master_detail_keep_state" %>
    ...
    <obout:Grid runat="server" ID="Grid1" AutoGenerateColumns="false" DataSourceID="sds1"
        ...
        <DetailGrids>
            <obout:DetailGrid runat="server" ID="Grid2" AutoGenerateColumns="false" AllowAddingRecords="false"
                AllowPageSizeSelection="false" DataSourceID="sds2"
                ...
                <Columns>
                    ...
                    <obout:Column DataField="Freight" Width="170" HeaderText="FREIGHT" DataFormatString="{0:C2}">
                    </obout:Column>
                </Columns>
                <MasterDetailSettings LoadingMode="OnCallback" />
                <DetailGrids>
                    <obout:DetailGrid runat="server" ID="Grid3" AutoGenerateColumns="false" AllowAddingRecords="false"
                        AllowPageSizeSelection="false" DataSourceID="sds3"
                        ...
                        <Columns>
                            ...
                            <obout:Column DataField="Quantity" HeaderText="QUANTITY" Width="170">
                            </obout:Column>
