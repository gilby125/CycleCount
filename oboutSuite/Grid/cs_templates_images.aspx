...
<script language="C#" runat="server">
    ...
    protected void DataBindEditBtnTemplate(Object sender, EventArgs e)
	{
        ...
        oLiteral.Text = "<img src=\"resources/images/Edit.png\" height=\"20\" onclick=\"grid1.edit_record(this)\" alt=\"\" title=\"Edit\" class=\"icon\" />  <img src=\"resources/images/Delete.png\" height=\"20\" onclick=\"grid1.delete_record(this)\" alt=\"\" title=\"Delete\" class=\"icon\"/>";
	}
	//------------------------------------------------------------------------
    ...
    protected void DataBindUpdateBtnTemplate(Object sender, EventArgs e)
    {
        ...
        oLiteral.Text = "<img src=\"resources/images/Save.png\" height=\"20\"  onclick=\"grid1.update_record(this)\" alt=\"\" title=\"Save\" class=\"icon\"/> <img src=\"resources/images/Delete.png\" height=\"20\" onclick=\"grid1.cancel_edit(this)\" alt=\"\" title=\"Cancel\" class=\"icon\" /> ";
    }
    //------------------------------------------------------------------------
    ...
    protected void DataBindAddTemplate(Object sender, EventArgs e)
    {
        ...
        oLiteral.Text = "<img src=\"resources/images/Add.png\" height=\"20\" onclick=\"grid1.addRecord()\" alt=\"\" title=\"Add New\" class=\"icon\"/>";
    }
    //------------------------------------------------------------------------
    ...
    protected void DataBindSaveTemplate(Object sender, EventArgs e)
    {
        ...
        oLiteral.Text = "<img src=\"resources/images/Save.png\" height=\"18\" onclick=\"grid1.insertRecord()\" alt=\"\" title=\"Save\" class=\"icon\"/> <img src=\"resources/images/Delete.png\" height=\"18\" onclick=\"grid1.cancelNewRecord()\" alt=\"\" title=\"Cancel\" class=\"icon\" />";
    }
    //------------------------------------------------------------------------
