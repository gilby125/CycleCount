...
<html>
	<head runat="server">
		<title>obout calendar example - Date range</title>
		<style type="text/css">
			body {
				font:11px Verdana;
				color:#333333;
	...
	<body>
	    <br /><br />
		<span class="tdText"><b>ASP.NET Grid - Task list example</b></span><br /><br />
                    ...
                    <td colspan="2">
                        <form runat="server">
                                    <obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" EnableTypeValidation="true" 
			                             FolderStyle="../grid/styles/grand_gray" AutoGenerateColumns="false" AllowColumnResizing="true" AllowRecordSelection="true" AllowPageSizeSelection="false"
