<%@ Page Title="" Language="C#" MasterPageFile="~/Grid/Grid.master" AutoEventWireup="true" CodeFile="aspnet_data_sources_needed.aspx.cs" Inherits="Grid_aspnet_data_sources_needed" %>
<%@ Register TagPrefix="obout" Namespace="Obout.Grid" Assembly="obout_Grid_NET" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <br />

	<span class="tdText"><b>ASP.NET Grid - Best Performance using the DataSourceNeeded Event</b></span>		
	
    <br /><br />

    <obout:Grid id="Grid1" runat="server" OnDataSourceNeeded="Grid1_DataSourceNeeded"
        AutoGenerateColumns="false" AllowAddingRecords="false" Serialize="false"
