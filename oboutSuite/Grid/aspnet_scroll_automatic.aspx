...
<script language="C#" runat="server">	
    ...
    void UpdateRecord(object sender, GridRecordEventArgs e)
    {
        ...
        OleDbCommand myComm = new OleDbCommand("UPDATE Orders SET ShipName = @ShipName, ShipCity = @ShipCity, ShipPostalCode=@ShipPostalCode, ShipCountry = @ShipCountry, OrderDate = @OrderDate, ShipVia = @ShipVia WHERE OrderID = @OrderID", myConn);
    ...
    void InsertRecord(object sender, GridRecordEventArgs e)
    {
        ...
        OleDbCommand myComm = new OleDbCommand("INSERT INTO Orders (ShipName, ShipCity, ShipPostalCode, ShipCountry, OrderDate, ShipVia) VALUES(@ShipName, @ShipCity, @ShipPostalCode, @ShipCountry)", myConn);
...
<html>
	...
	<body>	
		<form runat="server">					
		<br />
		<span class="tdText"><b>ASP.NET Grid - Automatic Scrolling</b></span>		
		<br /><br />
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false" PageSize="50"
			...
			<Columns>				
				...
				<obout:Column DataField="ShipVia" HeaderText="SHIP VIA" Width="200" runat="server" />
				<obout:Column AllowEdit="true" AllowDelete="true" HeaderText="" Width="150" runat="server" />
			</Columns>
			<ScrollingSettings ScrollHeight="250" ScrollWidth="700" ScrollLeft="200" ScrollTop="150"/>
		</obout:Grid>
					
		<br /><br /><br />
		
		<span class="tdText">
		    To scroll the Grid automatically you can use the <b>ScrollLeft</b> and <b>ScrollTop</b> properties.<br /><br />
		    The Grid also gets scrolled when you drag a selection zone with the mouse or when you click the "Add new" link.
		</span>
