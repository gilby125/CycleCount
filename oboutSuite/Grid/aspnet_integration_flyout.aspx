		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" 
			...
			<Templates>
				<obout:GridTemplate runat="server" ID="TemplateCompanyName">
					<Template>					    
						<span class="tdTextLink" id="grid_link_<%# Container.DataItem["SupplierID"] %>" onmouseover="attachFlyoutToLink(this, <%# Container.PageRecordIndex.ToString() %>)" onmouseout="closeFlyout()">More info...</span>
					</Template>
				</obout:GridTemplate>
			</Templates>				
		</obout:Grid>
