<%@ Page Title="" Language="C#" MasterPageFile="~/Grid/Grid.master" AutoEventWireup="true" CodeFile="aspnet_filtering_position.aspx.cs" Inherits="Grid_aspnet_filtering_position" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:Grid id="Grid1" runat="server" DataSourceID="SqlDataSource1" FolderStyle="styles/black_glass"        
        AutoGenerateColumns="false" AllowFiltering="true" Serialize="false" AllowAddingRecords="false"  AllowPageSizeSelection="false">
        <Columns>
            <obout:Column DataField="OrderID" Visible="false" />
            <obout:Column DataField="ShipCountry" HeaderText="SHIP COUNTRY" Width="180" />            
            <obout:Column DataField="ShipCity" HeaderText="SHIP CITY" Width="180" />
            <obout:Column DataField="ShipPostalCode" HeaderText="POSTAL CODE" Width="180" />
            <obout:Column DataField="ShipName" HeaderText="SHIP NAME" Width="200" />
        </Columns>
	    <PagingSettings Position="TopAndBottom" />
	    <FilteringSettings InitialState="Visible" FilterPosition="Bottom" FilterLinksPosition="TopAndBottom"/>
		</obout:Grid>
