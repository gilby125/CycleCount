...
<html>
	...
	<body>	
		<form runat="server">					
		<br />
		<span class="tdText"><b>ASP.NET Grid - Master / Detail - Using Multiple Foreign Keys</b></span>		
		...
		<obout:Grid runat="server" ID="grid1" AutoGenerateColumns="false"
            ...
            <DetailGrids>
                <obout:DetailGrid runat="server" ID="grid2" AutoGenerateColumns="false" 
                 ...
                 DataSourceID="sds2" FolderStyle="styles/grand_gray" ForeignKeys="CustomerID,Country">
                    <Columns>
                        ...
                        <obout:Column DataField="Country" HeaderText="COUNTRY" Visible="false"></obout:Column>
                    </Columns>
                    <MasterDetailSettings LoadingMode="OnCallback" />
                    <DetailGrids>
		...
		<span class="tdText">
		    The <b>ForeignKeys</b> property accepts multiple column names, separated by commas.
		</span>
				
		<asp:SqlDataSource runat="server" ID="sds1" SelectCommand="SELECT TOP 3 * FROM [Customers]"
		 ConnectionString="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|Northwind.mdb;" ProviderName="System.Data.OleDb"></asp:SqlDataSource>
		 
		<asp:SqlDataSource runat="server" ID="sds2" SelectCommand="SELECT *, ShipCountry AS Country FROM [Orders] WHERE CustomerID = ?"
