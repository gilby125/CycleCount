...
<script language="VB" runat="server">
    ...
    Sub Page_load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        grid1.ClientSideEvents.OnClientSelect = "function(sender, records) {loadDetails(sender, records, 'CustomerID');}"
        ...
        grid2.ClientSideEvents.OnClientSelect = "function(sender, records) {loadDetails(sender, records, 'OrderID');}"
...
<body>
    ...
    <span class="tdText">The detail grids can be expanded / collapsed when selecting a row
        in the master grid.</span>
