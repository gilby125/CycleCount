...
<html>
	...
	<body>	
		...
		<br />
		<span class="tdText"><b>ASP.NET Grid - Binding to a SqlDataSource</b></span>
		<br /><br />
		...
		<obout:Grid id="grid1" runat="server" CallbackMode="true" Serialize="true" AutoGenerateColumns="false"
			FolderStyle="styles/premiere_blue" AllowFiltering="true" DataSourceID="sds1"
		...
		<span class="tdText">
		    Use the <b>DataSourceId</b> property of the Grid to bind it to a SqlDataSource.
		</span>
