...
<body style="font: Tahoma 11px;">
	<h2>Obout TextMenu Smooth Black Example</h2>
	<br />
	<a class="examples" href="Default.aspx?type=ASPNET">« Back to examples</a>
	<br />
	<br />
    <div style="border-radius:20px 20px 20px 20px; border: 0px solid #000; padding:20px; background-color: #3b3b3b">
	<tm:TextMenu runat="server" id="tm1" StyleFolder="styles/smooth" Font="" FontParent="" SubMenuText="" DelayTimer="100"
                 ColorBackground="#3b3b3b" ColorBackgroundOver="#3b3b3b" ColorFont="#FFF" ColorFontOver="#CCC" >
