<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_ContentChanged.aspx.vb" Inherits="HTMLEditor_vb_ContentChanged" %>
<%@ Register
...
<body style="font:12px Verdana;" scroll="no">
    <span class="tdText"><b>Obout.Ajax.UI.HTMLEditor controls</b> - <b>ContentChanged</b> event handling
    <br /><br />
        ...
        <asp:UpdatePanel ID="updatePanel1" runat="server">
            <ContentTemplate>
               <obout:Editor runat="server" Id="editor" Height="400px" Width="600px">
                 <EditPanel OnContentChanged="contentChanged" />
               </obout:Editor>
               <br />
