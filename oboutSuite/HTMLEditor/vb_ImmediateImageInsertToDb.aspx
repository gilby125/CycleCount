<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_ImmediateImageInsertToDb.aspx.vb" Inherits="HTMLEditor_vb_ImmediateImageInsertToDb" %>
<%@ Register
...
<body  style="font:12px Verdana; overflow:hidden;" scroll="no">
    <span class="tdText"><b>Obout.Ajax.UI.HTMLEditor controls</b> - Images uploading to database with immediate inserting</span>
    <br /><br />
    Custom button
               ...
               <obout:Editor runat="server" Id="editor" Height="500px" Width="100%" PopupHolderID="popupHolder">
                 <TopToolBar Appearance="Lite" >
                    <AddButtons>
                        ...
                        <custom:ImmediateImageInsertToDb runat="server" />
                    </AddButtons>
                 </TopToolBar>
               </obout:Editor>
               <br />
