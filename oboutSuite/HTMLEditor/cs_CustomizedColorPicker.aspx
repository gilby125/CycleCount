<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cs_CustomizedColorPicker.aspx.cs" Inherits="HTMLEditor_cs_CustomizedColorPicker" %>
<%@ Register
...
<body>
    ...
    <img style="background-color:#C2C2C2;"
       src="<%=Page.ClientScript.GetWebResourceUrl(typeof(Obout.Ajax.UI.HTMLEditor.Editor),"Obout.Ajax.UI.HTMLEditor.Images.ed_selector_n.gif")%>"
    ...
    <img
       src="<%=Page.ClientScript.GetWebResourceUrl(typeof(Obout.Ajax.UI.ColorPicker.ColorPickerExtender),"Obout.Ajax.UI.ColorPicker.Images.SaveButton.gif")%>"
       onmouseover="this.src = '<%=Page.ClientScript.GetWebResourceUrl(typeof(Obout.Ajax.UI.ColorPicker.ColorPickerExtender),"Obout.Ajax.UI.ColorPicker.Images.SaveButtonOver.gif")%>';"
       onmouseout="this.src = '<%=Page.ClientScript.GetWebResourceUrl(typeof(Obout.Ajax.UI.ColorPicker.ColorPickerExtender),"Obout.Ajax.UI.ColorPicker.Images.SaveButton.gif")%>';"
