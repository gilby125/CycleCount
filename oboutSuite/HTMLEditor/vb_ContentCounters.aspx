<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_ContentCounters.aspx.vb" Inherits="HTMLEditor_vb_ContentCounters" %>
<%@ Register
...
<body style="font:12px Verdana;" scroll="no">
    <span class="tdText"><b>Obout.Ajax.UI.HTMLEditor controls</b> - Content counters</span>
    <br /><br />
    In the bottom toolbar you can see content counters (length of the plain text and HTML code).
    <br /><br />
