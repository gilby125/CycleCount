<%@ Page Language="VB" AutoEventWireup="true" CodeFile="vb_importMsWord.aspx.vb" Inherits="HTMLEditor_vb_importMsWord" %>
<%@ Register
...
<body style="font:12px Verdana;">
    ...
    <img style="background-color: blue;margin:0px;" align="absmiddle" alt=""
        src="<%= Page.ClientScript.GetWebResourceUrl(GetType(Obout.Ajax.UI.HTMLEditor.ToolbarButton.CommonButton), "Obout.Ajax.UI.HTMLEditor.Images.ed_importDocument_n.gif") %>" />
    .
    ...
    <form id="form1" runat="server">
        ...
        <obout:PopupHolder runat="server" ID="popupHolder" DefaultAddPolicy="Demand" >
            <Demand>
                <obout:ImportDocumentPopup ID="ImportDocumentPopup1" runat="server" DocumentReaders="+doc:docx:MsWordDocumentReader" />
            </Demand>
        </obout:PopupHolder>
                ...
                <obout:Editor runat="server" Id="editor" Height="500px" Width="100%">
                    <TopToolbar Appearance="Custom">
                        <AddButtons>
                            ...
                            <obout:RemoveAlignment ID="RemoveAlignment1" runat="server" />
                            <obout:HorizontalSeparator ID="HorizontalSeparator2" runat="server" />
                            <obout:ImportDocument ID="ImportDocument1" runat="server" />
                        </AddButtons>
                    </TopToolbar>
                </obout:Editor>
                <br />
