...
Partial Public Class FileUpload_vb_InsideFormView
    ...
    Protected Sub myItemUpdated(ByVal sender As Object, ByVal e As FormViewUpdatedEventArgs)
        Dim formView As System.Web.UI.WebControls.FormView = TryCast(sender, System.Web.UI.WebControls.FormView)
        Dim fileUpload As Obout.Ajax.UI.FileUpload.FileUpload = TryCast(formView.FindControl("fileUpload1"), Obout.Ajax.UI.FileUpload.FileUpload)
