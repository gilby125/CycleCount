<%@ Page Language="vb" inherits="emailclient_list" Src="vb_emailclient_list.aspx.vb" %>
<html>
<head>
<style>
.messageText
...
{
	window.parent.sp2.loadPage("RightContent", "vb_emailclient_detail.aspx?EmailID=" + EmailID);
}
</script>
</head>
...
<div style="background-color:white">
	...
	<%if (emailList.Items.Count > 0)  %><div style="border-top:1px solid gray;width:98%"></div><% End If %>
</div>
</body>
</html>