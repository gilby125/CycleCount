...
<html>
    ...
    <body>
	    ...
	    <br />
		<span class="tdText"><b>ASP.NET Splitter - HideBeforeLoad - Both</b></span>
	
		<br /><br />
	    <a style="font-size:10pt;font-family:Tahoma" href="Default.aspx?type=ASPNET">« Back to examples</a>
	    <br /><br />
            <spl:Splitter HideBeforeLoad="both" CookieDays="0" id="sp1DVF" runat="server" StyleFolder="styles/default/">
