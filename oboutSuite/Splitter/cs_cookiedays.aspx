...
<%@ Page Language="C#" Inherits="cs_cookiedays" Src="cs_cookiedays.aspx.cs" %>
...
<html>
	...
	<body>
        <form id="Form1" runat="server">
		    ...
		    <br />
		    <br />
		    <a href="cs_cookiedays.aspx">Click here to reload the page</a>.<br /><br />
		    <span class="tdText">First splitter will keep its previous separator position for 10 days. <br />
		    Second splitter will take its separator position from the component default value.</span>
		    </form>
	</body>
</html>