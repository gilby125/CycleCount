...
<html>
    ...
    <form id="Form1" runat="server">
	    <br />
		<span class="tdText"><b>ASP.NET Splitter - HideBeforeLoad - None</b></span>
	
		<br /><br />
	    <a style="font-size:10pt;font-family:Tahoma" href="Default.aspx?type=ASPNET">« Back to examples</a>
	    <br /><br />
            <spl:Splitter HideBeforeLoad="none" CookieDays="0" id="sp1DVF" runat="server" StyleFolder="styles/default/">
