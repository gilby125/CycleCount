<%@ Page Language="C#" Inherits="cs_withslidemenu" Src="cs_withslidemenu.aspx.cs" %>
        ...
        <form id="Form1" runat="server">
            ...
            <obspl:Splitter id="mySpl" runat="server" StyleFolder="styles/default_light" CookieDays="0">
	            <LeftPanel WidthDefault="170" WidthMin="150" WidthMax="350">
		            <content Url="cs_withslidemenu_left.aspx" />
	            </LeftPanel>
	            <RightPanel>
		            <content Url="cs_withslidemenu_main.aspx?cId=a_a" />					
	            </RightPanel>
            </obspl:Splitter>
        </form>
    </body>
