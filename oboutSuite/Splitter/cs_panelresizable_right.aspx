...
<%@ Page Language="C#" Inherits="cs_panelresizable_right" Src="cs_panelresizable_right.aspx.cs" %>
...
<html>
    ...
    <body>
        <form id="Form1" runat="server">
            <br />
	        <span class="tdText"><b>ASP.NET Splitter - Panel Resizable Right</b></span>
    	
	        <br /><br />
            <a style="font-size:10pt;font-family:Tahoma" href="Default.aspx?type=CSHARP">« Back to examples</a>
            <br /><br />
			<spl:Splitter id="spl1" runat="server">
				<LeftPanel>
					<Header>
