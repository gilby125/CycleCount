<%@ Page Language="C#" debug="true" Inherits="cs_company" Src="cs_company.aspx.cs" %>
	...
	<head>
		...
		<script language="JavaScript">
			function CompanySelect()
			{
				...
				splDV.loadPage("RightContent", "cs_companydetails.aspx?cID=" + cID);
			}
		</script>
	</head>
	<body>
        <form id="Form1" runat="server">
		    ...
		    <obspl:HorizontalSplitter StyleFolder="styles/default" id="splDV" runat="server" CookieDays="0">
			    ...
			    <BottomPanel>
				    <content Url="cs_companydetails.aspx" />
			    </BottomPanel>
