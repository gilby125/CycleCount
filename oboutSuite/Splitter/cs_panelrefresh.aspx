...
<%@ Page Language="c#" Inherits="cs_panelrefresh" Src="cs_panelrefresh.aspx.cs"%>
        ...
        <form id="Form1" runat="server">
		    ...
		    <obspl:Splitter CookieDays="0" id="sp1" runat="server" StyleFolder="styles/default">
			    <LeftPanel WidthMin="100" WidthMax="400" WidthDefault="180">
				    ...
				    <Content Url="cs_emailfolders.aspx" />
			    </LeftPanel>
			    <RightPanel>
				    <Content>
...
function EmailclientLoad(CategoryID)
{
	...
	sp2.loadPage("TopContent", "cs_emailclient_list.aspx?CategoryID="+CategoryID);
}
