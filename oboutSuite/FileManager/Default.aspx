...
<head runat="server">
    <title>obout ASP.NET FileManager examples</title>
    <style type="text/css">
                td.link{
                        padding-left:30px;
                        width:250px;                    
        ...
        <script type="text/javascript">
                ...
                function showexamples() {
                        var exSelect = document.form1.exSelect;
                        var prefix = "cs";
                ...
                window.onload = function() {
                        ...
                        if(oExamplesType.value == "CSHARP") {
                                document.form1.exSelect[0].checked = true;
                        } else if(oExamplesType.value == "VBNET") {
                                document.form1.exSelect[1].checked = true;
                        } else {
                            document.form1.exSelect[0].checked = true;
                        }
                        showexamples();
...
<body style="margin-left:30px;">
    ...
    <div class="tdText">
        ...
        <br /><br /><br />
        <span style="font-weight:bold;">Obout.Ajax.UI.FileManager examples</span>
        <br />
        <br />
        ...
        <br /><br />
        <b>Path to folder with FileManager examples: </b><asp:Label runat="server" ID="lblPath"></asp:Label>
        <br /><br />
                   ...
                   <table style="margin-top:0px;padding-top:0px;">
                       <tr>
                          <td valign="top" style="margin-top:0px;padding-top:0px;">
                              <table style="margin-top:0px;padding-top:0px;" cellspacing="3">
                                 <tr>
                                     <td class="link"><a href=""><nobr>Get information of the selected file using server-side</nobr></a></td>
                                     <td class="fname">cs_GetFileServerSide.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Get information of the selected file using client-side</nobr></a></td>
                                     <td class="fname">cs_GetFileClientSide.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Get selected Image using server-side</nobr></a></td>
                                     <td class="fname">cs_GetImageServerSide.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Get selected Image using client-side</nobr></a></td>
                                     <td class="fname">cs_GetImageClientSide.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Use different users folders to manage Images</nobr></a></td>
                                     <td class="fname">cs_DifferentUsers.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Set Images' folders in client-side</nobr></a></td>
                                     <td class="fname">cs_SetFoldersInClient.aspx</td>
                                 </tr>
                              </table>
                          </td>
                       </tr>
