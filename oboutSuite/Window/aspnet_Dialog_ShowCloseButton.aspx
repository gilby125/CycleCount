...
<head runat="server">
    <title>Dialog ShowCloseButton</title>

<script runat="server">
    void Page_Load(object o, EventArgs e)
    {
        myDialog.ShowCloseButton = bShowCloseButton.Checked;
    }
</script>
</head>
<body style="font-family:Tahoma;font-size:10pt;">
        ...
        <asp:CheckBox runat="server" ID="bShowCloseButton" Text = "Show Close Button" AutoPostBack="true"/>
        <br /><br />
