...
<head id="Head1" runat="server">
    <title>Dialog IsDraggable</title>

<script runat="server">
    void Page_Load(object o, EventArgs e)
    {
        myDialog.IsDraggable= bCondition.Checked;
    }
</script>
</head>
<body style="font-family:Tahoma;font-size:10pt;">
        ...
        <asp:CheckBox runat="server" ID="bCondition" Text = "Draggable" AutoPostBack="true" Checked="true"/>
