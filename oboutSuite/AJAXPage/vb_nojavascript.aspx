<%@ Page Language="vb" Inherits="vb_nojavascript" Src="vb_nojavascript.aspx.vb" %>
		...
		<table border="0">
			<tr>
				<td valign="top" width="630" colspan="4">
					<span class="title">Callback Panel - No Javascript</span><br /><br /><br />
				</td>
			</tr>
		</table>
		Update weather information with no page reload, periodically, using a server timer.
		<br />
		<br />
										...
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td valign="middle" align="left" style="font-family:arial,verdana;font-size:10px;color:#0B2C58;padding:0px 0px 5px 0px;">
													Updated <span style="color:crimson"><asp:Literal id="lDate" Runat="server"></asp:Literal></span>
												</td>
											</tr>  
										</table>
									</td>
