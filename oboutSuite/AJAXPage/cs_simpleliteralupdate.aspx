...
<%@ Page Language="C#" ASPCOMPAT="TRUE" Debug="true" Inherits="cs_simpleliteralupdate" Src="cs_simpleliteralupdate.aspx.cs" %>
<html>
	<head runat="server">
		<style>
		...
		<table border="0">
			<tr>
				<td valign="top" width="630" colspan="4">
					<span class="title">Simple Literal Update</span><br /><br /><br />
				</td>
			</tr>
		</table>
		<br />
