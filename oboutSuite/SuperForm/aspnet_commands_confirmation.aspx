<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_commands_confirmation.aspx.cs" Inherits="SuperForm_aspnet_commands_confirmation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        DefaultMode="Edit">
        <ClientSideEvents OnDeleting="SuperForm1_Deleting" OnInserting="SuperForm1_Inserting" OnUpdating="SuperForm1_Updating" />
    </obout:SuperForm>
