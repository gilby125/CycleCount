<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_templates_listbox.aspx.cs" Inherits="SuperForm_aspnet_templates_listbox" %>
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        <Fields>
            ...
            <obout:TemplateField HeaderText="Ship Country">
                ...
                <EditItemTemplate>
                    <obout:ListBox runat="server" ID="ShipCountry" DataSourceID="SqlDataSource2" Width="100%" Height="150"
