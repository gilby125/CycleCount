<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_linked_conditional.aspx.cs" Inherits="SuperForm_aspnet_linked_conditional" %>
       ...
       AutoGenerateRows="false"
        ...
        <Fields>
            ...
            <obout:DropDownListField DataField="CountryID" HeaderText="Country" Required="true"
                ...
                FieldsToEnable="StateID" EnablingValues="219" FieldsToDisable="Province" DisablingValues="219"  />
            ...
            <obout:CommandField ShowInsertButton="true" ShowCancelButton="false" ButtonType="Button" ItemStyle-HorizontalAlign="Center" />
        </Fields>
    </obout:SuperForm>
