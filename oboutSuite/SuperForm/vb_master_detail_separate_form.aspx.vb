...
Imports Obout.Grid
Partial Class SuperForm_vb_master_detail_separate_form
    ...
    Sub SuperForm1_ItemCommand(ByVal sender As Object, ByVal e As DetailsViewCommandEventArgs)
        ...
        If e.CommandName = "Cancel" Then
            ...
            Page.ClientScript.RegisterClientScriptBlock(GetType(Page), "grid", "location.href='vb_master_detail_separate.aspx';", True)
        End If
