<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_live_styles.aspx.vb" Inherits="SuperForm_vb_live_styles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText"><b>ASP.NET SuperForm - Live Styles</b></span>
    ...
    <span class="tdText">
        The SuperForm comes with predefined styles which are suited for most page layouts.<br /><br />
