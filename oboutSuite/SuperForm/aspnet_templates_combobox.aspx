<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_templates_combobox.aspx.cs" Inherits="SuperForm_aspnet_templates_combobox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText">
        ...
        Using the TemplateField class we can use a ComboBox to edit the data from the field.
    </span>
</asp:Content>
