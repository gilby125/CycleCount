<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_templates_combobox_multi.aspx.cs" Inherits="SuperForm_aspnet_templates_combobox_multi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        DefaultMode="Edit">
        <Fields>
            <obout:BoundField DataField="CustomerID" HeaderText="Customer ID" ReadOnly="true" InsertVisible="false" />
            ...
            <obout:TemplateField HeaderText="Countries">
                ...
                <EditItemTemplate>
                    <obout:ComboBox runat="server" ID="CountryIds" DataSourceID="SqlDataSource2" Height="150" Width="100%"
