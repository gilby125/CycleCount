<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="cs_master_detail_separate.aspx.cs" Inherits="SuperForm_cs_master_detail_separate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        function Grid1_Select(sender, records) {
            ...
            location.href = 'cs_master_detail_separate_form.aspx?OrderID=' + orderId;
        }
    </script>
</asp:Content>
