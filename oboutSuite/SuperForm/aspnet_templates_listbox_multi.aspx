<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_templates_listbox_multi.aspx.cs" Inherits="SuperForm_aspnet_templates_listbox_multi" %>
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        <Fields>
            ...
            <obout:TemplateField HeaderText="Countries">
                ...
                <EditItemTemplate>
                    <obout:ListBox runat="server" ID="CountryIds" DataSourceID="SqlDataSource2" Width="100%" Height="150"
