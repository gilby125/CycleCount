<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_linked_show.aspx.vb" Inherits="SuperForm_vb_linked_show" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText"><b>ASP.NET SuperForm - Show / Hide Linked Fields</b></span>
    ...
    <span class="tdText">
        The SuperForm supports the ability of linking fields. Using this feature you can set up some of the fields<br />
