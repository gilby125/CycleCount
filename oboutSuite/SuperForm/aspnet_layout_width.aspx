<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_layout_width.aspx.cs" Inherits="SuperForm_aspnet_layout_width" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        <Fields>
            ...
            <obout:DateField DataField="OrderDate" HeaderText="OrderDate" DataFormatString="{0:MM/dd/yyyy}" ApplyFormatInEditMode="true" />
            <obout:MultiLineField DataField="AdditionalInformation" HeaderText="Details" />
        </Fields>
    </obout:SuperForm>
