<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_live_styles_datefield.aspx.vb" Inherits="SuperForm_vb_live_styles_datefield" %>
    ...
    <table class="tdText">
        <tr>
            <td valign="top">
                ...
                <obout:ListBox runat="server" ID="ListBox1" AutoPostBack="true" Height="100" OnSelectedIndexChanged="CalendarType_Changed1">
            ...
            <td valign="top">
                ...
                <table cellspacing="10">
                    <tr>
                        ...
                        <td>
                            <obout:OboutRadioButton runat="server" OnCheckedChanged="CalendarType_Changed2" ID="DatePicker1" Text="date_picker1.gif" Checked="true" GroupName="DatePickerIcon" AutoPostBack="true" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td>
                            <obout:OboutRadioButton runat="server" OnCheckedChanged="CalendarType_Changed2" ID="DatePicker2" Text="date_picker2.gif" GroupName="DatePickerIcon" AutoPostBack="true" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td>
                            <obout:OboutRadioButton runat="server" OnCheckedChanged="CalendarType_Changed2" ID="DatePicker3" Text="icon2.gif" GroupName="DatePickerIcon" AutoPostBack="true" />
                        </td>
                    </tr>
                </table>
            </td>
