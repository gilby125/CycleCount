<%@ Page Title="" Language="C#" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="aspnet_fields_datefield_time.aspx.cs" Inherits="SuperForm_aspnet_fields_datefield_time" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:SuperForm ID="SuperForm1" 
        ...
        <Fields>
            ...
            <obout:DateField DataField="OrderDate" HeaderText="Order Date" DataFormatString="{0:MM/dd/yyyy hh:mm}" ApplyFormatInEditMode="true" />
            <obout:DateField DataField="ShippedDate" HeaderText=" Shipped Date" DataFormatString="{0:MM/dd/yyyy hh:mm}" ApplyFormatInEditMode="true" />
            <obout:DateField DataField="RequiredDate" HeaderText="Required Date" DataFormatString="{0:MM/dd/yyyy hh:mm}" ApplyFormatInEditMode="true" />
        </Fields>
    </obout:SuperForm>
