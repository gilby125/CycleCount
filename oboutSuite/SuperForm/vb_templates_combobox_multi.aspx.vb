...
Partial Class SuperForm_vb_templates_combobox_multi
    ...
    Function GetSelectedCountries() As String
        ...
        Dim CountryIds As Obout.ComboBox.ComboBox = CType(CType(SuperForm1.Rows(3), DetailsViewRow).FindControl("CountryIds"), Obout.ComboBox.ComboBox)

        Dim selectedCountryIds As String = ""

        For Each item As Obout.ComboBox.ComboBoxItem In CountryIds.Items
