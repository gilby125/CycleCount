<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_templates_listbox.aspx.vb" Inherits="SuperForm_vb_templates_listbox" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText"><b>ASP.NET Super Form - ListBox Field</b></span>
    ...
    <span class="tdText">
        ...
        Using the TemplateField class we can use a ListBox to edit the data from the field.
    </span>
</asp:Content>
