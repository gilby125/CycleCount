<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_templates_combobox_multi.aspx.vb" Inherits="SuperForm_vb_templates_combobox_multi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <span class="tdText"><b>ASP.NET Super Form - Multi Select ComboBox Field</b></span>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO Customers (CompanyName, ContactName, CountryIds)
                        VALUES(@CompanyName, @ContactName, @CountryIds)"
    ...
    <span class="tdText">
        ...
        Using the TemplateField class we can use a Multi Select ComboBox to edit the data from the field.
    </span>
</asp:Content>
