<%@ Page Title="" Language="VB" MasterPageFile="~/SuperForm/SuperForm.master" AutoEventWireup="true" CodeFile="vb_master_detail_separate.aspx.vb" Inherits="SuperForm_vb_master_detail_separate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript">
        function Grid1_Select(sender, records) {
            ...
            location.href = 'vb_master_detail_separate_form.aspx?OrderID=' + orderId;
        }
    </script>
</asp:Content>
