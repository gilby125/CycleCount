    ...
    <script language="C#" runat="server">
        ...
        void Page_Init(object sender, EventArgs e)
        {
            ...
            ObTree = new Tree()
            {
                ...
                OnNodeDragging = "onClientNodeDrag",
                NodeDropTargets = "Panel;dropTextBox;dropTextArea;dropImg",
                EnableDragAndDrop = true,
                Width = 250
            };

            Node nodeImg = new Node()
            {
                Text = "Images",
                Expanded = true
            };

            nodeImg.ChildNodes.Add(new Node()
            {
                Text = "Nature 1",
                Value = "img/nature/nature1.jpg"
            });
            nodeImg.ChildNodes.Add(new Node()
            {
                Text = "Nature 2",
                Value = "img/nature/nature2.jpg"
            });
            nodeImg.ChildNodes.Add(new Node()
            {
                Text = "Nature 3",
                Value = "img/nature/nature3.jpg"
            });
            nodeImg.ChildNodes.Add(new Node()
            {
                Text = "Nature 4",
                Value = "img/nature/nature4.jpg"
            });
            this.ObTree.TreeNodeDrop += new NodeDropEventHandler(ObTree_TreeNodeDrop);
            this.ObTree.Nodes.Add(nodeImg);
