...
<body>
    ...
    <table class="tb_sample">
        <tr>
            <td>
                <obout:Tree NodeDropTargets="GridPanel" CssClass="vista" ID="ObTree"
                    OnTreeNodeDrop="ObTree_TreeNodeDrop" EnableDragAndDrop="true" runat="server">
                    <Nodes>
                        <obout:Node ImageUrl="img/ob_product.png" Text="oboutSuite" AllowDrop="false" Expanded="true"
                            Value="199">
                            <obout:Node Text="TreeView" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="Grid" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="Calendar" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="HTMLEditor" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="SlideMenu" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="EasyMenu" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="ComboBox" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="99">
                            </obout:Node>
                            <obout:Node Text="Ajax Page" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="0">
                            </obout:Node>
                            <obout:Node Text="Show" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="0">
                            </obout:Node>
                            <obout:Node Text="Interface Controls" ImageUrl="img/vista-download-icon.jpg" AllowDrop="false"
                                Value="0">
                            </obout:Node>
                        </obout:Node>
                    </Nodes>
