...
<head id="Head1" runat="server">
    ...
    <script language="C#" runat="server"> 
        ...
        void Page_Init(object sender, EventArgs e)
        {
            ...
            ObTree = new Tree()
                       {
                           ID = "VistaTree",
                           AllowNodeEdit = true,
                           OnBeforeNodeEdit = "OnClientBeforeNodeEdit",
                           OnNodeEdit = "OnClientNodeEdit",
                           CssClass = "vista"
                       };
            ...
            nodePict.ChildNodes.Add(new Node()
            {
                Text = "My Pictures",
    ...
    <script language="C#" runat="server">
        ...
        {
            this.ObTree.AllowNodeEdit = chk_allowEdit.Checked;
        }
    </script>
