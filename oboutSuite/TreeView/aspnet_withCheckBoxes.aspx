...
<head id="Head1" runat="server">
        ...
        protected void getCheckedNodes(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(checkedNodes.Value))
            {
                ...
                for (int i = 0; i < nodeIndexes.Length; i++)
                {
                    ...
                    // from the root
                    NodeCollection nodes = ObClassicTree.Nodes;
                    Node node = null;
                    // search for the node
    ...
    <script type="text/javascript">
        ...
        function checkboxClick(checkBox) {
            ...
            var treeView = $find("<%= ObClassicTree.ClientID %>");
...
<body>
    ...
    <table border="0">
        <tr>
            <td valign="top">
                <obout:Tree ID="ObClassicTree" runat="server" OnNodeSelect="cancelSelect" >
                    <Nodes>
                        <obout:Node Text="Products" Expanded="true">
                            <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>ASP.NET Controls" Expanded="true">
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>Grid" Value="Grid">
                                </obout:Node>
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>Calendar" Value="Calendar">
                                </obout:Node>
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>Interface Controls" Value="Interface">
                                </obout:Node>
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>ASP.NET Ajax Controls" Expanded="true">
                                    <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>FileUpload" Value="FileUpload">
                                    </obout:Node>
                                    <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>HTML Editor" Value="AjaxEditor">
                                    </obout:Node>
                                    <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>TreeView" Value="TreeView">
                                    </obout:Node>
                                </obout:Node>
                            </obout:Node>
                            <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>ASP.NET MVC Controls" Expanded="true">
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>Interface Controls" Value="MVCInterface">
                                </obout:Node>
                                <obout:Node Text="<input type='checkbox' onclick='checkboxClick(this)'>HTML Editor" Value="MVCEditor">
                                </obout:Node>
                            </obout:Node>
                        </obout:Node>
                    </Nodes>
