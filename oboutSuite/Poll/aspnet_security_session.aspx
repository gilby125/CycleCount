<%@ Page Title="" Language="C#" MasterPageFile="~/Poll/Poll.master" AutoEventWireup="true" CodeFile="aspnet_security_session.aspx.cs" Inherits="Poll_aspnet_security_session" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <obout:Poll runat="server" ID="Poll1" DataSourceID="SqlDataSource1"
        ...
        AllowedVotesPerUser="1" SecurityMethod="Session">
    </obout:Poll>
