<%@ Page Title="" Language="C#" MasterPageFile="~/Poll/Poll.master" AutoEventWireup="true" CodeFile="aspnet_security_cookies.aspx.cs" Inherits="Poll_aspnet_security_cookies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<span class="tdText"><b>ASP.NET Poll - Security - Cookies</b></span>
    ...
    <obout:Poll runat="server" ID="Poll1" DataSourceID="SqlDataSource1"
        ...
        CssClass="ob_pMCont" CurrentMode="Answers" DataTextField="AnswerText" 
        DataValueField="AnswerID" DataVotesField="Votes" StyleFile="" 
        VotingMode="SingleAnswer" Width="300px">
    </obout:Poll>
    ...
    <div style="width: 600px;" class="tdText">
        ...
        This example showcases the use of the <b>Cookies</b> security method. <b>AllowedVotesPerUser</b> is set to 1, 
        so you will be able to vote only once. If you try with a different browser or clear your cookies, you'll be able to vote again.
    </div>
</asp:Content>
