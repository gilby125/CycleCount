<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cs_Features.aspx.cs" Inherits="SiteMap_cs_Features" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br /><br />
        <asp:SiteMapDataSource ID="SiteMapDataSource1" ShowStartingNode="false" runat="server" SiteMapProvider="SamplesSiteMap" />
