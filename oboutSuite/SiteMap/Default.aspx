...
<head runat="server">
    <title>obout ASP.NET SiteMap examples</title>
    <style type="text/css">
                td.link{
                        padding-left:30px;
                        width:250px;                    
...
<body style="margin-left:30px;">
    ...
    <div class="tdText">
        ...
        <br /><br /><br />
        <span style="font-weight:bold;">Obout.Ajax.UI.SiteMap examples</span>
        <br />
        <br />
        ...
        <br /><br />
        <b>Path to folder with SiteMap examples: </b><asp:Label runat="server" ID="lblPath"></asp:Label>
        <br /><br />
                       ...
                       <tr>
                          <td valign="top" style="margin-top:0px;padding-top:0px;">
                              <table style="margin-top:0px;padding-top:0px;" cellspacing="3">
                                 <tr>
                                     <td class="link"><a href=""><nobr>Features</nobr></a></td>
                                     <td class="fname">cs_Features.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Flow Layout of the control</nobr></a></td>
                                     <td class="fname">cs_FlowLayout.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>Client-side Functionality</nobr></a></td>
                                     <td class="fname">cs_ClientSideFunctionality.aspx</td>
                                 </tr>
                              </table>
                          </td>
                       </tr>
