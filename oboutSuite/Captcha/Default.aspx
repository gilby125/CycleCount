...
<body style="margin-left:30px;">
    ...
    <div class="tdText">
        ...
        <br /><br />
        <b>Path to folder with Captcha examples: </b><asp:Label runat="server" ID="lblPath"></asp:Label>
        <br /><br />
                       ...
                       <tr>
                          <td valign="top" style="margin-top:0px;padding-top:0px;">
                              <table style="margin-top:0px;padding-top:0px;">
                                 ...
                                 <tr>
                                     <td class="link"><a href="">In UserControl with audio feature</a></td>
                                     <td class="fname">cs_UserControlWithAudio.aspx</td>
                                 </tr>

                                 <tr>
                                     <td class="link"><a href="">In <b>jQuery</b> Mobile Page</a></td>
                                     <td class="fname">cs_jQueryMobilePage.aspx</td>
                                 </tr>
                              </table>
                          </td>
                       </tr>
