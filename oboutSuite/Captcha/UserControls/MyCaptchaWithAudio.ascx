<%@ Control Language="C#" ClassName="MyCaptchaWithAudio" AutoEventWireup="true" %>
...
<table runat="server" id="MainTable">
    <tr>
        <td valign="middle">
            <obout:CaptchaImage ID="InnerCaptchaImage" runat="server" TextLength="5" AudioEnabled="true"
                BackColor="WhiteSmoke" TextBrush="Horizontal" BackBrush="Solid" AudioLinkID="GetAudioCode"
