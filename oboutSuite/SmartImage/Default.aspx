...
<head runat="server">
    <title>obout ASP.NET SmartImage examples</title>
    <style type="text/css">
                td.link{
                        padding-left:30px;
                        width:250px;                    
...
<body style="margin-left:30px;">
    ...
    <div class="tdText">
        ...
        <br /><br /><br />
        <span style="font-weight:bold;">Obout.Ajax.UI.SmartImage examples</span>
        <br />
        <br />
        ...
        <br /><br />
        <b>Path to folder with SmartImage examples: </b><asp:Label runat="server" ID="lblPath"></asp:Label>
        <br /><br />
                       ...
                       <tr>
                          <td valign="top" style="margin-top:0px;padding-top:0px;">
                              <table style="margin-top:0px;padding-top:0px;" cellspacing="3">
                                 <tr>
                                     <td class="link"><a href=""><nobr>Binding to Datatable</nobr></a></td>
                                     <td class="fname">cs_DataTableDataSource.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>With the obout <b>FileUpload</b> as data source</nobr></a></td>
                                     <td class="fname">cs_FileUploadDataSource.aspx</td>
                                 </tr>
                                 <tr>
                                     <td class="link"><a href=""><nobr>With Image URL</nobr></a></td>
                                     <td class="fname">cs_ImageUrl.aspx</td>
                                 </tr>
                              </table>
                          </td>
                       </tr>
