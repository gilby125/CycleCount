...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Current panel</b></span>
		    <br /><br />
		    <table>
		    <tr>
			    <td>
				    <obshow:Show id="Show1" runat="server" Width="400" Height="187" ShowType="manual" ManualChanger="true">
					    <Changer Width="400" Height="30" Type="Both" />
					    <Panels>
						    <obshow:Panel>
			    ...
			    <td class="tdText" valign="top" style="padding-left:40px;padding-top:20px;">
				    <nobr>Number of panels: <div style="display:inline;font-weight:bold;" id="divPanelsCount"></div></nobr><br />
				    Current selected panel is <div style="display:inline;font-weight:bold;color:red;" id="divCurrentPanel"></div>.
			    </td>
		    </tr>
	    </table>
...
<script type="text/javascript">
	...
	{
		//debugger
		var divPanelsCount = document.getElementById('divPanelsCount');
		var divCurrentPanel = document.getElementById('divCurrentPanel');
		
		divPanelsCount.innerHTML = Show1.PanelsCount;
		divCurrentPanel.innerHTML = Show1.CurrentPanel;
	}
</script>
