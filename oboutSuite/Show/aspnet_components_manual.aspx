...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Components manual</b></span>
		    <br /><br />
		    <obshow:Show id="Show1" runat="server" StyleFolder="styles/style6" Width="700" Height="250" 
			    ShowType="manual" ManualChanger="true">
		    <Changer Width="700" Height="30" Type="Both" />
		    <Panels>
			    <obshow:Panel>
