...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		 <form id="Form1" runat="server">
		     ...
		     <span class="tdText"><b>ASP.NET Show - Play/Pause show</b></span>
	         <br /><br /><br />
		        <table>
			        <tr>
				        <td>
					        <obshow:Show id="Show1" runat="server" StyleFolder="styles/style5" 
						        Width="625" Height="350" ShowType="Show" ManualChanger="true">
						        <Changer Type="Both" ArrowType="Side1" Height="40" Width="625" HorizontalAlign="center" />
						        <Panels>
							        <obshow:Panel>
