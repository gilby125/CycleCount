...
<script language="C#" runat="server">
	...
	void Page_Load(object sender, EventArgs e) {
		...
		string sConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + Server.MapPath("../App_Data/Show_Panels.mdb");
		OleDbConnection myConn = new OleDbConnection(sConnectionString);
		myConn.Open();
		
		string query = "SELECT ImagePath FROM Show_Panels";
		OleDbCommand myComm = new OleDbCommand(query, myConn);
		OleDbDataReader oReader = myComm.ExecuteReader();
		
		while (oReader.Read())
		{
			string sImagePath = oReader.GetString(0);
			Show1.AddImagePanel(sImagePath);
		}
...
<html>
	...
	<form id="Form1" runat="server">
		...
		<span class="tdText"><b>ASP.NET Show - Image URL's from database</b></span>
