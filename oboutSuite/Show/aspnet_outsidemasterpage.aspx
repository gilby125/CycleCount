...
<%@ Page Language="C#" MasterPageFile="aspnet_outsidemasterpage.master" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <obshow:Show id="Show1" runat="server" Width="700" Height="220" ShowType="Show" TransitionType="none">
		<Panels>
			<obshow:Panel>
