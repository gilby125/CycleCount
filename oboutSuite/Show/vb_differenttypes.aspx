<%@ Page Language="vb" Src="vb_differenttypes.aspx.vb" Inherits="vb_differenttypes" %>
			    ...
			    <td align="left" class="tdText" style="padding-left:8px;padding-top:15px;">
				    <table>
					    <tr>
						    ...
						    <td>
							    <asp:DropDownList AutoPostBack="True" id="ddlChangerType" OnSelectedIndexChanged="ChangeChangerType" runat="server">
