...
<%@ Page Language="C#" MasterPageFile="MasterPage.master" Inherits="cs_withmasterpage" Src="cs_withmasterpage.aspx.cs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<style type="text/css">
       ...
       <obshow:Show id="Show1" runat="server">
	    ...
	    <a style="font-size:8pt;font-family:Tahoma" href="Default.aspx?type=CSHARP">« Back to examples</a>
