	...
	<head runat="server">
	 ...
	 <body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Absolute position of manual changer</b></span>
    	
	        <br /><br /> 
	        <table>
	        <tr>
		        <td>
			        <obshow:Show id="Show1" StyleFolder="styles/style_absolute" runat="server" Width="300" Height="190" ShowType="manual" ManualChanger="true">
				        <Changer Type="Both" Height="30" Width="350" AllowAbsolutePosition="true" />
				        <Panels>
					        <obshow:Panel>
