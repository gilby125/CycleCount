	...
	<body>
		 <form id="Form1" runat="server">
	         ...
	         <br /><br /><br />
		        ...
		        <tr>
			        <td>
				        <obshow:Show id="Show1" runat="server" Width="370" Height="175" ShowType="show" ManualChanger="false" 
					        TransitionType="fading" TimeBetweenPanels="3000">
					        <Panels>
						        <obshow:Panel>
		        ...
		        <tr>
			        <td>
				        <obshow:Show id="Show2" runat="server" Width="370" Height="175" ShowType="show" ManualChanger="false" 
					        TransitionType="none" TimeBetweenPanels="2000">
					        <Panels>
						        <obshow:Panel>
