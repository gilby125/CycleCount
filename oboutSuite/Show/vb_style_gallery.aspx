<%@ Page Language="vb" Inherits="vb_style_gallery" Src="vb_style_gallery.aspx.vb" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Style gallery example</b></span>
		    <br /><br />
		    ...
		    <table>
			    <tr>
				    ...
				    <td valign="top">
					    <asp:ListBox id="lbLiveStyles" OnSelectedIndexChanged="ChangeStyle" style="overflow:hidden;height:190px;" runat="server" AutoPostBack="True">
