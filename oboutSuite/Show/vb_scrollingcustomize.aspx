<%@ Page Language="vb" Inherits="vb_scrollingcustomize" Src="vb_scrollingcustomize.aspx.vb" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Scrolling customize</b></span>
		    <br /><br />
			    ...
			    <td align="left" class="tdText" style="padding-left:8px;padding-top:15px;">
				    <table>
					    ...
					    <tr>
						    ...
						    <td>
							    <asp:DropDownList OnSelectedIndexChanged="ChangeScrollDirection" AutoPostBack="True" id="ddlScrollDirection" runat="server">
