...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        <form id="Form1" runat="server">
	        <span class="tdText"><b>ASP.NET Show - Manual changer type</b></span>
		    <br /><br /><br />
		    <table>
		    <tr>
			    <td>
				    <obshow:Show id="Show1" StyleFolder="styles/style5" runat="server" Width="300" Height="190" ShowType="manual" ManualChanger="true">
					    <Changer Type="Arrow" Height="30" Width="350" />
					    <Panels>
						    <obshow:Panel>
			    ...
			    <td align="left" class="tdText" style="padding-left:8px;padding-top:15px;">
				    <table>
					    <tr>
						    ...
						    <td>
							    <asp:DropDownList AutoPostBack="True" id="ddlChangerType" runat="server">
