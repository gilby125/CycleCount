...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		 <form id="Form1" runat="server">
		     ...
		     <span class="tdText"><b>ASP.NET Show - Quick News</b></span>
	         <br /><br /><br />
	        <div class="showContainer">
	        <obshow:Show id="Show1" runat="server" Width="420" Height="92" ShowType="show" TransitionType="QuickScroll" ScrollDirection="Top">
		        <Panels>
			        <obshow:Panel>
