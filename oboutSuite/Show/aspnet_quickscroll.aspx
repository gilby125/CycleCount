...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		 <form id="Form1" runat="server">
		     ...
		     <span class="tdText"><b>ASP.NET Show - Quick Scroll</b></span>
	         <br /><br /><br />
		
		        <obshow:Show id="Show1" runat="server" Width="700" Height="220" ShowType="show" ScrollDirection="top" TransitionType="QuickScroll">
		        <Panels>
			        <obshow:Panel>
